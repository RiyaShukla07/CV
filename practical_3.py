...
Original file is located at
    https://colab.research.google.com/drive/1pKPSr-YEmCgqelCFVuRzMK4kwEt5n9ph
"""
...
# file
image = cv2.imread(r"../content/panda.png")
if image is None:
...
# Load the image
panda = imread('../content/image')  # use the correct filename
...
tiger = imread('../content/flower')  # include file extension
imshow(tiger)
plt.axis('off')
print(tiger.shape)